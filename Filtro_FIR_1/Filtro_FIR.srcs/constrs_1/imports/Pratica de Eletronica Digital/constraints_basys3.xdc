...
# Switches
set_property PACKAGE_PIN V17 [get_ports {cl}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cl}]
set_property PACKAGE_PIN V16 [get_ports {ca0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ca0}]
set_property PACKAGE_PIN W16 [get_ports {ca1}]					
...
set_property PACKAGE_PIN V15 [get_ports {x[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {x[2]}]
set_property PACKAGE_PIN W14 [get_ports {x[3]}]					
...
set_property PACKAGE_PIN T3 [get_ports {x[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {x[6]}]
set_property PACKAGE_PIN T2 [get_ports {x[7]}]					
...
#set_property PACKAGE_PIN W18 [get_ports {seletor}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seletor}]
#set_property PACKAGE_PIN U15 [get_ports {sf}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sf}]
#set_property PACKAGE_PIN U14 [get_ports {sg}]					
